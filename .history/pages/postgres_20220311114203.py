...
# Create a Table    
    ...
    col2.subheader("Managing Indexes")
    col2.markdown('''
	``` sql
    ...
    col2.markdown('''
                  ```python# Query All DataSELECT * FROM table_name;# Query Data  from specific columns from all rowsSELECT column_listFROM table# Query Data and sleect only unique rowsSELECT DISTINCT (column)FROM table# Query data from a table with a filter:SELECT *FROM tableWHERE condition;SELECT * FROM table WHERE course='CS101';
